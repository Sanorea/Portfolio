...
export class Translations {
  ...
  private readonly STORAGE_KEY = 'currentLang';
  currentLang: 'de' | 'en' = (localStorage.getItem(this.STORAGE_KEY) as 'de' | 'en') || 'en';
  languageChanged = new EventEmitter<'de' | 'en'>();
  ...
  setLanguage(lang: 'de' | 'en') {
    if (this.currentLang !== lang) {
      ...
      localStorage.setItem(this.STORAGE_KEY, lang);  // ⬅️ Sprache merken
